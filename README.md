<div align="center">
  <br />
    <a href="https://banking-app-platform.vercel.app" target="_blank">
      <img src="./public/icons/readme_img.png" alt="Project Banner">
    </a>
  <br />
...
Built with Next.js, F-Bank is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether. 
...
```bash
git clone https://github.com/RuslanFom/banking_app_platform.git
cd banking_app_platform
```
